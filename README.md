...
The code to analyse the data corresponds to the file Analysis_AUC_KCV.R which calls the two source files, funciones.R and funciones_KCV.R, containing the functions needed to compute the local linear estimators and to choose the bandwidth through K-fold cross-validation.
